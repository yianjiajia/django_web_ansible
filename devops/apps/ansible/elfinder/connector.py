...
from exceptions import ElfinderErrorMessages, VolumeNotFoundError, DirNotFoundError, FileNotFoundError, NamedError, \
    NotAnImageError
...
class ElfinderConnector:
    ...
    _commands = {
        ...
        'dim': {'target': True},
        'resize': {'target': True, 'width': True, 'height': True, 'mode': False, 'x': False, 'y': False,
                   'degree': False},
        # TODO: implement netmount
        'netmount': {'protocol': True, 'host': True, 'path': False, 'port': False, 'user': True, 'pass': True,
                     'alias': False, 'options': False}
    }
    ...
    def _file(self, target, request=None, download=False):
        ...
        **Command**: Get a file
        ...
        if download:
            ...
            disp = 'inline' if re.match('(image|text)', file_['mime'], re.IGNORECASE) or file_[
                                                                                             'mime'] == 'application/x-shockwave-flash' else 'attachment'
            mime = file_['mime']
        ...
        **Command**: Create a new directory. This method should not be invoked 
        ...
        try:
            ...
            return {'error': self.error(ElfinderErrorMessages.ERROR_MKDIR, name,
                                        ElfinderErrorMessages.ERROR_TRGDIR_NOT_FOUND, '#%s' % target)}
    ...
    def _rename(self, target, name):
        ...
        **Command**: Rename a file. This method should not be invoked 
        ...
        try:
            ...
            return {'error': self.error(ElfinderErrorMessages.ERROR_RENAME, '#%s' % target,
        ...
        **Command**: Duplicate a file. Create a copy with "{suffix} %d" suffix,
        ...
        for target in targets:
            try:
                ...
                result['warning'] = self.error(ElfinderErrorMessages.ERROR_COPY, u'#%s' % target,
                                               ElfinderErrorMessages.ERROR_FILE_NOT_FOUND)
                continue
        ...
        **Command**: Remove directories or files. This method should not be invoked 
        ...
        for target in targets:
            try:
                ...
                result['warning'] = self.error(ElfinderErrorMessages.ERROR_RM, '#%s' % target,
                                               ElfinderErrorMessages.ERROR_FILE_NOT_FOUND)
                continue
    ...
    def _upload(self, target, FILES, html=False):
        ...
        **Command**: Save uploaded files. This method should not be invoked 
        ...
        if not isinstance(files, list) or not files:
            return {
                'error': self.error(ElfinderErrorMessages.ERROR_UPLOAD, ElfinderErrorMessages.ERROR_UPLOAD_NO_FILES),
                'header': header}
        ...
        try:
            ...
            return {
                'error': self.error(ElfinderErrorMessages.ERROR_UPLOAD, ElfinderErrorMessages.ERROR_TRGDIR_NOT_FOUND,
    ...
    def _paste(self, targets, dst, cut=False):
        ...
        **Command**: Copy/move ``targets`` files into a new destination ``dst``.
        ...
        try:
            ...
            return {'error': self.error(error, u'#%s' % targets[0], ElfinderErrorMessages.ERROR_TRGDIR_NOT_FOUND,
                                        u'#%s' % dst)}
    ...
    def _put(self, target, content):
       ...
       **Command**:  Save ``content`` into a text file. This method should not be invoked 
        ...
        try:
            ...
            return {'error': self.error(ElfinderErrorMessages.ERROR_SAVE, u'#%s' % target,
                                        ElfinderErrorMessages.ERROR_FILE_NOT_FOUND)}
    ...
    def _extract(self, target):
        ...
        **Command**:  Extract files from archive. This method should not be invoked 
        ...
        try:
            ...
            return {'error': self.error(ElfinderErrorMessages.ERROR_EXTRACT, u'#%s' % target,
                                        ElfinderErrorMessages.ERROR_FILE_NOT_FOUND)}
    ...
    def _archive(self, targets, type_):
        ...
        **Command**: Create a new archive file containing all files in
        ...
        try:
            ...
            return {
                'error': self.error(ElfinderErrorMessages.ERROR_ARCHIVE, ElfinderErrorMessages.ERROR_TRGDIR_NOT_FOUND)}
    ...
    def _resize(self, target, width, height, mode=None, x='0', y='0', degree='0'):
        ...
        **Command**: Resize ``target`` image. This method should not be invoked 
        ...
        try:
            ...
            return {'error': self.error(ElfinderErrorMessages.ERROR_RESIZE, '#%s' % target,
                                        ElfinderErrorMessages.ERROR_FILE_NOT_FOUND)}
