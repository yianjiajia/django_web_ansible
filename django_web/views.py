...
import django_web.settings

from django_web.lib.django_util import render
    ...
    if request.method == 'POST':
        ...
        if lang_code and check_for_language(lang_code):
            if hasattr(request,'session'):
                ...
                response.set_cookie(django_web.settings.LANGUAGE_COOKIE_NAME,lang_code,max_age,expires)
    return response
